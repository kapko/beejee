...
export class AppService{
  ...
  updateUrl: string = 'https://uxcandy.com/~shapoval/test-task-backend/edit/';
  ...
  updateData(data: Object, url: string): Observable<any> {
    return this.http.post(`${this.updateUrl}${url}`, data).map(items => items.json())
  }
